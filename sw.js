const CACHE='qg-cbm-rr-v6';
const ASSETS=['./','./index.html','./styles.css','./app.js','./supabase-sync.js','./supabase-sync.css','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
